...
the [OpenAI API](https://platform.openai.com/), offering various functions for
...
Refer to the [project page](https://github.com/pmatiello/openai-api)
and [documentation](https://cljdoc.org/d/me.pmatiello/openai-api/) for more.
